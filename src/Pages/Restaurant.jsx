...
<h1 className='rest' style={{fontFamily:' "Merriweather Sans", sans-serif',fontSize:"80px"}}>Restaurants</h1>
<p>Taste the Heart of Thillenkery: Where Every Bite Tells a Tale of Tradition and Passion.</p>

        </Col>
        
        <Col md={6} >
<img style={{width:"75%"}} className='img2' src={img2} alt="" />
        </Col>
    </Row>
