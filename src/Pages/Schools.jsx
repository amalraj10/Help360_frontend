...
<h1 className='rest' style={{fontFamily:' "Merriweather Sans", sans-serif',fontSize:"80px",color:"#5e63cd"}}>Schools</h1>
<p>Schools: Nurturing Minds, Shaping Futures in Thillenkery.</p>

        </Col>
        
        <Col style={{marginTop:"15%"}} md={6} >
<img style={{width:"100%"}} src={schoolss} alt="" />
        </Col>
    </Row>
